...
Monetization artifacts live here.

This area should validate willingness to pay before billing complexity is implemented.

Planned artifacts:

- willingness-to-pay review
- [`pricing-hypothesis-template.md`](pricing-hypothesis-template.md)
- billing strategy
- Stripe or payment approval gate
